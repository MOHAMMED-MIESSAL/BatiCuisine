...
public class User {
    ...
    public User(int id, String name, String address, String phone , boolean is_professional) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "User {id=" + id + ", name='" + name + '\'' + ", address='" + address + '\'' + ", phone='" + phone + '\'' + ", is_professional=" + is_professional + '}';
    }
}
